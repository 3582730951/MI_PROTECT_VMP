...
target_link_libraries(rewriter_lift_sample PRIVATE vmp_runtime_vm1 vmp_runtime_env_integrity vmp_runtime_stack_probe vmp_runtime_trusted_oracle vmp_runtime_cryptor vmp_runtime_strings vmp_runtime_audit vmp_policy vmp_arch_common nlohmann_json::nlohmann_json)
''')
    build = work / 'build'
