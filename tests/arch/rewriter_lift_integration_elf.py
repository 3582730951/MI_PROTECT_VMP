...
target_include_directories(vmp_runtime_vm1 PUBLIC {source_root}/runtime/vm1/include {source_root}/runtime/strings/include {source_root}/runtime/audit/include {source_root}/policy/include)
target_link_libraries(vmp_runtime_vm1 PUBLIC vmp_runtime_strings vmp_runtime_audit vmp_policy nlohmann_json::nlohmann_json)
target_link_libraries(rewriter_lift_sample PRIVATE vmp_runtime_vm1 vmp_runtime_strings vmp_runtime_audit vmp_policy nlohmann_json::nlohmann_json)
''')
    build = work / 'build'
